...
- Trackpad swipe gestures for back/forward navigation
- Non-Google links open in your default browser
...
- **No JavaScript injection** — the app never reads or modifies page content
...
- Credentials go straight to `accounts.google.com` — the Swift layer never sees them
